...
7. **Parcel Conflicts**: When deploying a scene, any existing scene overlapping any parcel is deleted
8. **Multi-Scene Support**: Multiple scenes can exist per world, each occupying different parcels
9. **Spawn Coordinates**: Must reference a parcel within autogenerated world grid
